...
public class Smartphone {
    ...
    //metodo di reset che permette di resettare tutte le caratteristiche dello smartphone con altre scelte dall'utente
    public void reset(
        final int cpuCount,
        final int ram,
        final int sdSize,
        ...
        //non è possibile resettare le caratteristiche di uno smartphone, in quanto sono tutte final
    }
